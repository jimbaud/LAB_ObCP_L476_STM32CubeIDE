...
void Make_Connection(void)
{
	...
	const char local_name[] = {AD_TYPE_COMPLETE_LOCAL_NAME, 'O', 'B', 'C', 'P', '-', 'C', 'R', 'O', 'C'};
...
{
	BLE_command_received(data_buffer); // Appelle une fonction externe pour traiter les données.
}
...
void MX_BlueNRG_MS_Init(void)
{
	...
	aci_gap_init_IDB05A1(GAP_PERIPHERAL_ROLE_IDB05A1, 0, 0x09, &service_handle, &dev_name_char_handle, &appearance_char_handle);
